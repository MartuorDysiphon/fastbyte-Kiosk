    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="staff-modal">
        ...
        <div className="staff-body">
          {!clerkKey ? (
            <NoClerkFallback onClose={onClose} />
          ) : (
            <>
              <SignedOut>
...
function NoClerkFallback({ onClose }) {
  return (
    <div className="staff-no-clerk">
      ...
      <p>
        Add your <code>VITE_CLERK_PUBLISHABLE_KEY</code> to the <code>.env</code> file to enable staff authentication.
      </p>
      <a href="https://clerk.com" target="_blank" rel="noopener noreferrer" className="clerk-setup-link">
        Set up Clerk →
      </a>
